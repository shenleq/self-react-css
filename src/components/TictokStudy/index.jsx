      ...
      <div className="home">
        <div className="home-div">
          <div className="home-item">
            <div className="circleCon">
              <Button onClick={() => {timeOff(0)}} >渲染1000</Button>
              <div/>
            </div>
          </div>
          <div className="home-item">
            <div className="left" >
              <div>文字交融展开</div>
              <Button onClick={() => {textClick()}}>点击交互</Button>
            </div>
            <div className="right">
              <div className="text-con">
                <span className={textUp ? "text-con-span text-up-ani" : "text-con-span"}>Yisa Education</span>
              </div>
            </div>
          </div>
          <div className="home-item">
          ...
          <div className="home-item">
            ...
            <div className="right">
              <div className="shoufeng">
                <div><img src={QiQiu}/><span>这是气球</span></div>
                <div><img src={QiQiu}/><span>这是气球</span></div>
                <div><img src={QiQiu}/><span>这是气球</span></div>
                <div><img src={QiQiu}/><span>这是气球</span></div>
                <div><img src={QiQiu}/><span>这是气球</span></div>
            ...
            <div className="right">
              <div className="changyi">
                <p>
                  ...
                  the way we act, and the way we interact with the world around us.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="home-div">
          ...
          <div className="home-item"> 
            <div className="left">
              <div>文字特效</div>
              <Button onClick={() => {textClick2()}}>点击交互</Button>
            </div>
            <div className="right">
          ...
          <div className="home-item">
            ...
            <div className="right">
              <div className="shange change1">
                mui
              </div>
              <div className="shange">
                koenkk
              </div>
              <div className="shange change2">
                louislam
              </div>
            </div>
          </div>
        ...
        <div className="home-div">
          <div className="home-item">
            ...
            <ul className="ul-move">
                <li>
                  <a href="javascript:;"><i className="fa-brands fa-facebook-f"></i>云之家</a>
                </li>
                <li>
                  <a href="javascript:;"><i className="fa-brands fa-twitter"></i>企业微信</a>
                </li>
                <li>
                  <a href="javascript:;"><i className="fa-brands fa-google"></i>E-HR</a>
                </li>
                <li>
                  <a href="javascript:;"><i className="fa-brands fa-linkedin"></i>一周小结</a>
                </li>
                <li>
                  <a href="javascript:;"><i className="fa-brands fa-instagram"></i>签到</a>
                </li>
              </ul>
            </div>
          </div>
              ...
              <div className="Menu">
                <ul className="Menu-list" data-offset="10">
                  <li className="Menu-list-item" data-offset="20">
                    首页
                    <span className="Mask"><span>首页</span></span>
                    <span className="Mask"><span>首页</span></span>
                  </li>
                  <li className="Menu-list-item" data-offset="16">
                    关于
                    <span className="Mask"><span>关于</span></span>
                    <span className="Mask"><span>关于</span></span>
                  </li>
                  <li className="Menu-list-item" data-offset="12">
                    记录
                    <span className="Mask"><span>记录</span></span>
                    <span className="Mask"><span>记录</span></span>
                  </li>
                  <li className="Menu-list-item" data-offset="8">
                    热点
                    <span className="Mask"><span>热点</span></span>
                    <span className="Mask"><span>热点</span></span>
                  </li>
                </ul>
              </div>
        ...
        <div className="home-div">
          ...
          <div className="home-item">
            ...
            <div className="right">
              ...
              <a href="https://dribbble.com/YancyMin" className="dr-url" target="_blank">
              <img className="dr" src="https://cdn.dribbble.com/assets/logo-footer-hd-a05db77841b4b27c0bf23ec1378e97c988190dfe7d26e32e1faea7269f9e001b.png" alt=""/></a>
            </div>
          </div>
          <div className="home-item">
            <div className="left">
